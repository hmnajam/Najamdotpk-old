...
export default function HeroSection() {
  // Defining DownloadIcon within the HeroSection component
  const DownloadIcon = createIcon({
    ...
    path: (
      <path
        fill="currentColor"
        d="M15.293 12.293L13 14.586V7a1 1 0 0 0-2 0v7.586l-2.293-2.293a1 1 0 0 0-1.414 1.414l4 4a1 1 0 0 0 1.414 0l4-4a1 1 0 1 0-1.414-1.414z"
      />
    ),
  });
